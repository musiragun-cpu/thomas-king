...
<section class="radiology">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item radiology" style="opacity: 1; display: flex;">
                <div class="img">
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    현대의학에서 질병 진단의 중심 역할을 하는 MRI, CT 등 첨단영상의학 검사기기를 이용한
                    전문영상진단센터로 각종 증상에 대한 1차적인 문진과 함께 필요한 영상검사를 시행하여
                    즉시 검사결과를 설명하는 새로운 시스템으로 의사와 환자가 만나는 가장 이상적인 방법입니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL ?>/img/img_summary11.jpg" alt="영상의학과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL ?>/ico/ico_white_department11.png" alt="영상의학과 아이콘">
                </div>
            </div>
        </article>
