...
<section class="neurology">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item neurology">
                <div class="img">
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    신경과는 뇌와 척수, 말초신경 및 근육에 발생하는 질환을 진단하고 치료하는 과입니다.
                </p>
                <p class="txt01">
                    경산중앙병원의 신경과에서 진료하는 대표적인 질환으로는 뇌혈관의 이상에 의하여 발생하는
                    뇌졸중, 경련 또는 발작이 나타나는 뇌전증, 보행장애 및 손떨림이 나타나는 파킨슨병과 같은
                    운동 이상 질환, 대뇌의 기능 감퇴로 발생하는 치매와 같은 퇴행성 질환, 손발저림 및 근육의
                    마비가 발생하는 말초신경 및 근육질환, 뇌염이나 뇌수막염 등의 감염성 질환, 두통 어지럼증
                    등이 있습니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL ?>/img/img_summary05.jpg" alt="신경과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL ?>/ico/ico_white_department05.png" alt="신경과 아이콘">
                </div>
            </div>
        </article>
    </div>
