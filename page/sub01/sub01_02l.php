...
<section class="anesthesia">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item anesthesiology" style="opacity: 1; display: flex;">
                <div class="img">
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    마취과 의사는 수술 전 환자를 파악하여 진단과 치료를 요하는 사항이 있으면 협진하여 해결합니다.
                    수술 중에 일어나는 변화는 물론 다른 원인으로 인한 변화에도 대처하여 수술 중 환자가 최선의
                    상태를 유지하도록 관리합니다. 수술 후 환자를 회복실로 옮긴 후에는 의식의 정도, 심혈관계의
                    변화, 호흡상태, 출혈, 체온의 변화와 운동기능 등을 조사한 후, 마취에서 회복이 이루어져 병실로
                    이송할 때까지 모든 관리를 맡아서 어려운 상황속에서도 환자의 안녕을 위해 일을 하는 곳입니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL ?>/img/img_summary12.jpg" alt="마취통증의학과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL ?>/ico/ico_white_department12.png" alt="마취통증의학과 아이콘">
                </div>
            </div>
        </article>
