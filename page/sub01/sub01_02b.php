...
<section class="orthopedics">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item orthopedic">
                <div class="img">
                ...
                <div class="content">
                    ...
                    <p>관절 (어깨, 무릎, 고관절), 인공관절수술, 관절경 수술, 관절염, 골다공증, 퇴행성질환, 스포츠 손상, 응급의료</p>
                    <div class="d_btn">
                        <p class="openModalBtn" data-modal="modal01">약력 정보</p>
                        <p class="openModalBtn" data-modal="modal02">진료 일정</p>
                    </div>
                ...
                <div id="modal01" class="modal modal01">
                    <div class="modal-content">
                        ...
                        <ul>
                            <li>- 경북대학교 의과대학 졸업</li>
                            <li>- 대구파티마병원 정형외과 전문의 취득
                            </li>
                            <li>- 국제 골절학회 (AO) 골절 코스 연수</li>
                            <li>- 대한통증학회 근막통증증후군 (TPI) 치료과정 연수</li>
                            <li>- 대한정형외과학회 정회원</li>
                            <li>- 대한견주·슬관절학회 정회원</li>
                        </ul>
                    </div>
                </div>
                <div id="modal02" class="modal modal02">
                ...
                <div id="modal01" class="modal modal01">
                    <div class="modal-content">
                        ...
                        <ul>
                            ...
                            <li>- 영남대학교병원 정형외과 전문의 취득</li>
                            <li>- 영남대학교병원 어깨, 팔꿈치 관절, 무릎관절 임상교수 역임
                            </li><li>- 대한통증학회 근막통증증후군 치료(TPI) 치료과정 연수</li>
                            <li>- 대한견주·슬관절학회 정회원</li>
                            <li>- 국제 골절학회 (AO) 정회원 및 전체 코스 수료, 최우수상 수상</li>
                        </ul>
                    </div>
                </div>
                <div id="modal02" class="modal modal02">
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    경산중앙병원의 정형외과는 골,관절을 중심으로 운동기계의 질환이 주요 진료대상입니다.
                    골 및 관절의 염증을 비롯한 영양장애로 인한 변화와 신경장애로 인한 변화, 선천성 기형 등
                    변형에 대한 형태의 교정이나 기능회복 등을 목적으로 수술적 또는 비수술적 치료 진행합니다.
                </p>
                <p class="txt01">
                    본원의 정형외과는 분야별 최고의 전문의가 상주하고 있으며, 보다 심층적이고 과학적인 진료를
                    위해 부설 특수클리닉센타인 '관절센터'를 외래와 동시에 운영하고 있습니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL ?>/img/img_summary02.jpg" alt="정형외과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL ?>/ico/ico_white_department02.png" alt="정형외과 아이콘">
                </div>
            </div>
        </article>
