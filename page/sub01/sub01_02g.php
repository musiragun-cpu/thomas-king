...
<section class="gynecology">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item obgyn" style="opacity: 1; display: flex;">
                <div class="img">
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    경산중앙병원 산부인과에서는 산전진찰(분만제외), 월경이상, 내분비질환과 불임을 담당하는
                    생식의학, 여성의 악성종양을 담당하는 부인과종양, 부인암검사, 폐경기관리 등의 질환을
                    진료하고 있습니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL?>/img/img_summary07.jpg" alt="산부인과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL?>/ico/ico_white_department07.png" alt="산부인과 아이콘">
                </div>
            </div>
        </article>
