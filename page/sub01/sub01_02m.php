...
<section class="laboratory">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item labmed" style="opacity: 1; display: flex;">
                <div class="img">
                ...
                <div class="content">
                    ...
                    <p>진단혈액학, 수혈의학, 면역혈청, 임상화학, 임상미생물, 유전 및 분자진단</p>
                    <div class="d_btn">
                        <p class="openModalBtn" data-modal="modal01">약력 정보</p>
                        <p class="openModalBtn" data-modal="modal02">진료 일정</p>
                    </div>
                ...
                <div id="modal01" class="modal modal01" style="display: none;">
                    <div class="modal-content">
                        ...
                        <ul>
                            ...
                            <li>- 서울순천향대학교 의학박사 수료</li>
                            <li>- 국민보험공단 건강검진기관 검사실 심사위원 역임</li>
                            <li>- 심사평가원 심의위원 역임</li>
                        </ul>
                    </div>
                </div>
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    진단검사의학과는 인체에서 유래하는 혈액, 소변, 체액 및 조직 등의 각종 검체에 대하여 적절한
                    검사를 적용, 선택하고 시행할뿐만 아니라 검사 결과를 판독함으로써 질병의 조기 발견과 진단,
                    치료 효과의 판정 및 예후 추정에 도움을 주는 과입니다.
                </p>
                <p class="txt01">
                    검사업무에 따라 진단혈액, 임상화학, 혈액은행, 면역혈청, 뇨 체액분석, 응급검사, 채혈실 등의
                    세부 부서로 나뉘어져 있으며 보다 신속하고 정확한 검사수행 및 신뢰성 있는 결과 제공을 위해
                    최선의 노력을 다하고 있습니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL?>/img/img_summary13.jpg" alt="진단검사의학과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL?>/ico/ico_white_department13.png" alt="진단검사의학과 아이콘">
                </div>
            </div>
        </article>
