...
<section class="psychiatry">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item psychiatry">
                <div class="img">
                ...
                <div id="modal01" class="modal modal01">
                    <div class="modal-content">
                        ...
                        <ul>
                            ...
                            <li>- 경북대학교 대학원 석,박사 취득</li>
                            <li>- 대구카톨릭대학교 정신건강의학과 조교수 역임</li>
                            <li>- 우리세명병원 병원장 역임</li>
                            <li>- 대한신경정신의학회 정회원</li>
                        </ul>
                    </div>
                ...
                <div id="modal01" class="modal modal01">
                    <div class="modal-content">
                        ...
                        <ul>
                            <li>- 경북대학교 의과대학 졸업</li>
                            <li>- 경북대학교병원 정신건강의학과 전문의 취득</li>
                            <li>- 포항시 알코올상담센터장 역임</li>
                            <li>- (현) 영천시 정신건강 심의위원회 위원</li>
                            <li>- (현) 경상북도의사회 학술이사</li>
                            <li>- (현) 성부정신수양원 촉탁의</li>
                        </ul>
                    </div>
                </div>
                ...
                <div id="modal01" class="modal modal01">
                    <div class="modal-content">
                        ...
                        <ul>
                            ...
                            <li>- 경북대학교병원 정신건강의학과 전문의 취득</li>
                            <li>- 경북대학교 대학원 박사 수료</li>
                            <li>- 대한불안의학회 불안장애 심층치료과정 수료</li>
                            <li>- 대한신경정신의학회 정회원</li>
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    경산중앙병원의 정신건강의학과에서는 다양한 질환을 다루고 있으며, 특히 종합병원으로서
                    정신과적인 문제 외에 다른 관련 임상과와의 협진을 통한 통합적 접근 및 치료가 가능합니다.
                </p>
                <p class="txt01">
                    주요 진단 항목으로는 스트레스성 질환, 신경성질환(신경성 위염), 불면증, 두통, 불안, 우울증,
                    물질관련장애, 정신증 등이 있습니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL ?>/img/img_summary06.jpg" alt="정신건강의학과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL ?>/ico/ico_white_department06.png" alt="정신건강의학과 아이콘">
                </div>
            </div>
        </article>
    </div>
