...
<section class="family">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item family" style="opacity: 1; display: flex;">
                <div class="img">
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    경산중앙병원 가정의학과에서는 평생 주치의로서 건강증진 및 질병의 예방과 진단, 치료 등
                    모든 과정에 동반자로서의 역할을 담당합니다.
                </p>
                <p class="txt01">
                    주로 급성 및 만성질환의 지속적 관리, 건강검진, 예방접종, 건강위험요인 관리(흡연, 비만 등)를
                    통한 건강증진을 도와드립니다. 또한 현대 의료가 기관 중심으로 복잡하고 세분화되어 있어 환자가
                    본인에게 맞는 적절한 진료를 받기 어려운 환경으로 어느 진료과에서 어떤 진료를 받아야 할지
                    모를 때 가정의학과에서 도와 드립니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL?>/img/img_summary10.jpg" alt="가정의학과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL?>/ico/ico_white_department10.png" alt="가정의학과 아이콘">
                </div>
            </div>
        </article>
