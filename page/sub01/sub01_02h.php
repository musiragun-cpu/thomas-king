...
<section class="youth">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item pediatrics" style="opacity: 1; display: flex;">
                <div class="img">
                ...
                <div class="content">
                    ...
                    <p>소아호흡기, 알러지, 아토피, 소아소화기, 비만, 예방접종, 육아상담</p>
                    <div class="d_btn">
                        <p class="openModalBtn" data-modal="modal01">약력 정보</p>
                        <p class="openModalBtn" data-modal="modal02">진료 일정</p>
                    </div>
                ...
                <div id="modal01" class="modal modal01">
                    <div class="modal-content">
                        ...
                        <ul>
                            ...
                            <li>- 포항성모병원 소아청소년과 과장 역임</li>
                            <li>- 대한소아청소년학회 정회원</li>
                            <li>- 대한 소아소화기영양학회 정회원</li>
                        </ul>
                    </div>
                </div>
                <div id="modal02" class="modal modal02">
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    소아청소년과는 소아기(태어나서부터 성장이 멈출 때까지)에 속하는 모든 연령에서 발생할 수 있는
                    질병을 치료 또는 예방하여 정상적인 성장과 발달을 이루게 하여, 궁극적으로 각자가 속한 사회에서
                    정상적으로 활동하고 생활할 수 있게 하는 것을 목표로 합니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL?>/img/img_summary08.jpg" alt="소아청소년과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL?>/ico/ico_white_department08.png" alt="소아청소년과 아이콘">
                </div>
            </div>
        </article>
    </div>
