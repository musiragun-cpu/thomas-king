...
<section class="emergency">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item emergency" style="opacity: 1; display: flex;">
                <div class="img">
                ...
                <div id="modal01" class="modal modal01" style="display: none;">
                    <div class="modal-content">
                        ...
                        <ul>
                            ...
                            <li>- 2022년 50회 보건의날 도지사 표창 수상</li>
                            <li>- (현) 경산중앙병원 응급의학과 주임과장</li>
                            <li>- (현) 경산 소방본부(119) 지도전문의</li>
                        </ul>
                    </div>
                </div>
                <div id="modal02" class="modal modal02">
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    응급실전문의는 응급실을 찾는 환자에게 초기 진단부터 결정까지 1시간 이내로 원스톱으로
                    진행합니다.
                </p>
                <p class="txt01">
                    생명이 위중한 환자가 병원에 도착했을때 바로 수술을 할 수 있어야 합니다. 골든타임을 놓치게
                    되면 사망률이 높아지는 만큼, 언제 어디서 터질지 모르는 응급상황을 위해 경산중앙병원은
                    365일 24시간 응급의학전문의가 항시 대기하고 있습니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL?>/img/img_summary14.jpg" alt="응급의학과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL?>/ico/ico_white_department14.png" alt="응급의학과 아이콘">
                </div>
            </div>
        </article>
