...
<section class="surgery">
    <div class="inner">
        ...
        <article class="doctor_itemWrap">
            ...
            <div class="doctor_item surgery">
                ...
                <div class="content">
                    ...
                    <p>유방, 갑상선질환, 복강경수술, 대장, 항문질환, 담낭질환, 탈장, 양성종양제거(지방종)</p>
                    <div class="d_btn">
                        <p class="openModalBtn" data-modal="modal01">약력 정보</p>
                        <p class="openModalBtn" data-modal="modal02">진료 일정</p>
                    </div>
        ...
        <article class="summary subBg">
            <div class="txt_con">
                <p class="txt01">
                    경산중앙병원 외과는 주로 유방, 갑상선, 화상 등의 분야에 진단 및 치료를 담당하고
                    있으며, 응급상황으로 내원하는 환자들을 응급센터와 유기적이고 신속한 진료시스템을
                    통해 진단 및 치료하고 있습니다.
                </p>
            ...
            <div class="img_con">
                <img src="<?php echo G5_IMG_URL ?>/img/img_summary04.jpg" alt="외과 이미지">
                <div class="icon_box">
                    <img src="<?php echo G5_IMG_URL ?>/ico/ico_white_department04.png" alt="외과 아이콘">
                </div>
            </div>
        </article>
    </div>
