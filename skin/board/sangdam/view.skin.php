...
if($view['wr_10'] == '접수'){
  ...
  $stat_text1 = '10%';
  $stat_text2 = '접수';
} else if($view['wr_10'] == '상담중'){
  $stat_i = "stat_2";
  $stat_text1 = '70%';
  $stat_text2 = '상담중';
} else if($view['wr_10'] == '완료'){
  $stat_i = "stat_3";
  $stat_text1 = '100%';
  $stat_text2 = '완료';
}
...
<article id="bo_v" class="inner" style="width:<?php echo $width; ?>">
    <div>
        <div id="bo_v_title">
            <div class="stat_percent <?php echo $stat_i;?>">
              <span><?php echo $stat_text1; ?></span>
            <?php echo $stat_text2; ?></div>
        </div>
    </div>

    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <span>상담구분</span> <strong><?php echo $view['wr_1'] ?></strong><br>
        <span>작성자</span> <strong><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong><br>
        <span>연락처</span> <strong><?php echo $view['wr_subject'] ?></strong><br>
        <span>댓글</span><strong><a href="#bo_vc"> <i class="fa fa-commenting-o" aria-hidden="true"></i> <?php echo number_format($view['wr_comment']) ?>건</a></strong><br>
        <span>조회</span><strong><i class="fa fa-eye" aria-hidden="true"></i> <?php echo number_format($view['wr_hit']) ?>회</strong><br>
        <span>작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?><br>
