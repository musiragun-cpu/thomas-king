...
<section id="bo_w" class="inner">
    ...
    <?php if ($is_admin == 'super') { ?>
        <div class="frm_input full_input">
            <label for="wr_10"><strong>상태:&nbsp;&nbsp;&nbsp;&nbsp;</strong></label>
            <input type="radio" name="wr_10" value="접수" <?php echo ($write['wr_10']=='접수')?'checked':''; ?> >접수&nbsp;&nbsp;
            <input type="radio" name="wr_10" value="상담중" <?php echo ($write['wr_10']=='상담중')?'checked':''; ?> >상담중&nbsp;&nbsp;
            <input type="radio" name="wr_10" value="완료" <?php echo ($write['wr_10']=='완료')?'checked':''; ?> >완료
        </div>
    <?php } ?>
    ...
    <div class="frm_input full_input">
        <label for="wr_1"><strong>상담구분:&nbsp;&nbsp;&nbsp;&nbsp;</strong></label>
        <input type="radio" name="wr_1" value="강좌" required <?php echo ($write['wr_1']=='강좌')?'checked':''; ?> >강좌&nbsp;&nbsp;
        <input type="radio" name="wr_1" value="프로그램" required <?php echo ($write['wr_1']=='프로그램')?'checked':''; ?> >프로그램&nbsp;&nbsp;
        <input type="radio" name="wr_1" value="홈페이지제작" required <?php echo ($write['wr_1']=='홈페이지제작')?'checked':''; ?> >홈페이지제작
    </div>
    <div class="bo_w_tit">
        <label for="wr_subject" class="sound_only">연락처<strong>필수</strong></label>

        <div id="autosave_wrapper">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="연락처">
