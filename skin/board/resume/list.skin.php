            ...
            <div class="gall_box">
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_text_href">
                        ...
                        <?php if ($list[$i]['wr_4'] =='마감') { ?>
                            <div class="condition end">
                                <p class="ct"><?php echo $list[$i]['wr_4'] ?></p>
                            </div>
                        <?php } ?>

                        <?php if ($list[$i]['wr_4'] =='진행중') { ?>
                            <div class="condition ing">
                                <p class="ct"><?php echo $list[$i]['wr_4'] ?></p>
                            </div>
                        <?php } ?>
                            </div>
                    ...
                    <div class="gall_info">
                        <span class="gall_date"><span class="sound_only">작성일 </span> <?php echo date("Y.m.d", strtotime($list[$i]['wr_datetime'])) ?></span>
                    </div>
...
<script>
            ...
            let conditionTxt = document.querySelector('.condition > p')
            console.log(condition.innerText)
            let classAdd = () =>{
                if(conditionTxt.innerText == '마감'){
                    condition.classList.add('end')
                }
            }
