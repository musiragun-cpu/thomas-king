        ...
        <div id="bo_v_con">
            <div class="bg_gray">
                <div class="view_con">
                    ...
                    <p class="timeCon"><?php echo date("Y.m.d", strtotime($view['wr_datetime'])) ?></p>
                </div>
            ...
            <div class="list_href">
                <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=resume">
                    <span class="ct">목록으로</span>
                </a>
            </div>
...
const viewCondition = document.querySelector('.view_condition')
const viewConditionTxt = document.querySelector('.view_condition > p')
console.log(viewConditionTxt.innerText)
console.log(viewCondition)
if(viewConditionTxt.innerText == "진행중"){
    viewCondition.style.backgroundColor="#7AC5EE"
}
</script>
<!-- } 게시글 읽기 끝 -->