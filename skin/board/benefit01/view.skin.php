...
;
    ...
    <section id="bo_v_atc">
        ...
        <p>
            분류 : <?php echo $view['wr_2'] ?>
        </p>
        <p>
            명칭 : <?php echo $view['wr_3'] ?>
        </p>
        <p>
            코드 : <?php echo $view['wr_4'] ?>
        </p>
        <p>
            구분 : <?php echo $view['wr_5'] ?>
        </p>
        <p>
            비용 : <?php echo $view['wr_6'] ?>
        </p>
        <p>
            최저비용 : <?php echo $view['wr_7'] ?>
        </p>
        <p>
            최고비용 : <?php echo $view['wr_8'] ?>
        </p>
        <p>
            치료재료대포함여부 : <?php echo $view['wr_9'] ?>
        </p>
        <p>
            약제비호함여부 : <?php echo $view['wr_10'] ?>
        </p>
