...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_con">
            ...
            <p>
                분류 : <?php echo $view['wr_1'] ?>
            </p>
            <p>
                명칭 : <?php echo $view['wr_2'] ?>
            </p>
            <p>
                코드 : <?php echo $view['wr_3'] ?>
            </p>
            <p>
                구분 : <?php echo $view['wr_4'] ?>
            </p>
            <p>
                비용 : <?php echo $view['wr_5'] ?>
            </p>
            <p>
                특이사항 : <?php echo $view['wr_10'] ?>
            </p>
            <p>
                최종변경일 : <?php echo $view['wr_subject'] ?>
            </p>
