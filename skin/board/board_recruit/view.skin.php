...
<article id="bo_v" class="board_news" style="width:<?php echo $width; ?>">
        ...
        <span class="bo_v_tit">
            <?php if ($category_name) { ?>
                <span class="bo_v_cate"><?php echo $view['ca_name']; // 분류 출력 끝 
                                        ?></span>
            <?php } ?>
            <!-- <span class="statusSpan"><?php echo $view['wr_5']; // 진행현황 출력 
                                        ?></span> -->
            <?php
    ...
    <section id="bo_v_info">
        ...
        <div class="gall_info">
            ...
            <span class="gall_date"><span class="sound_only">작성일 </span><!--<i class="fa fa-clock-o"
                                aria-hidden="true"></i>--><?php echo date("y-m-d", strtotime($view['datetime'])) ?></span>
            <span class="mx-3">
            ...
            <?php echo $view['wr_3']; // 접수기간 출력 
            ?>
            <span class="mx-1">
                ~
            </span>
            <?php echo $view['wr_4']; // 접수기간 출력 
            ?>
            <span class="mx-3">
                <svg width="2" height="18" viewBox="0 0 2 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 0V18" stroke="#E1E1E1" />
    ...
    <div class="boardBtnWrap">
        <ul class="bo_v_nb">
            <?php if ($prev_href) { ?>
                <li class="btn_prv" onclick="location.href='<?php echo $prev_href ?>'"><span class="nb_tit">
            ...
            <?php if ($next_href) { ?>
                <li class="btn_next" onclick="location.href='<?php echo $next_href ?>'"><span class="nb_tit">
                    next
                    <svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        statusSpans.forEach(function(span) {
            if (span.textContent.trim() === "접수 중") {
                span.classList.add('btnBlue');
            } else {
                span.classList.add('btnGray');
            }
        });
    });
</script>