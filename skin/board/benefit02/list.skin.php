...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="page_tab">
        <span onclick="location.href='https://unidgyeongsan.mycafe24.com/bbs/board.php?bo_table=price01'" class="">행위</span>
        <span onclick="location.href='https://unidgyeongsan.mycafe24.com/bbs/board.php?bo_table=price02'" class="active">치료재료</span>
            ...
            <table align="center">
                ...
                <thead>
                    <tr>
                        ...
                        <?php if ($is_checkbox) { ?>
                            <th rowspan=2 scope="col" class="all_chk chk_box">
                        ...
                        <?php } ?>
                        <!-- <th rowspan=2 colspan=2 scope="col">분류</th> -->
                        <th colspan=2 scope="col">진료비용항목</th>
                        <th colspan=2 scope="col">항목별 가격정보(단위:원)</th>
