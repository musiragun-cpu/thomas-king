...
<article id="bo_v" class="board_news" style="width:<?php echo $width; ?>">
    ...
    <thead>
        <tr>
            <th>예약신청일</th>
            <td><?php echo cut_str(get_text($view['wr_1']), 70); // 예약신청일 출력 ?></td>
        </tr>
        <tr>
            <th>이름</th>
            <td><?php echo cut_str(get_text($view['wr_name']), 70); // 이름 출력 ?></td>
        </tr>
        <tr>
            <th>학교명</th>
            <td><?php echo cut_str(get_text($view['content']), 70); // 학교명 출력 ?></td>
        </tr>
        <tr>
            <th>학년/반/번호</th>
            <td><?php echo cut_str(get_text($view['wr_2']), 70); // 학년 출력 ?>학년
            <?php echo cut_str(get_text($view['wr_3']), 70); // 반 출력 ?>반
            <?php echo cut_str(get_text($view['wr_4']), 70); // 반 출력 ?>번
        </td>
        </tr>
        <tr>
            <th>연락처</th>
            <td><?php echo cut_str(get_text($view['wr_subject']), 70); // 연락처 출력 ?></td>
        </tr>
        <tr>
            <th>이메일</th>
            <td><?php echo cut_str(get_text($view['wr_email']), 70); // 이메일 출력 ?></td>
        </tr>
    </thead>
</table>
